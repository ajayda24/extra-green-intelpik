...
class OrderDetailsTable extends Component {
  ...
  render() {
    console.log('get')
    const { setStep, staff } = this.context
...
OrderDetailsTable.contextType = mainContext
