...
export default function RegistrationAreaDrawerMobile() {
  ...
  const list = () => (
    <div className={classes.list}>
      ...
      <List style={{ backgroundColor: '#3C4B64' }}>
        <ListItem button component={RouterLink} to='/Admin/RegistrationArea'>
          <ListItemText>Add State</ListItemText>
        </ListItem>
        <ListItem
          button
          component={RouterLink}
          to='/Admin/RegistrationArea/District'
        >
          <ListItemText>Add District</ListItemText>
        </ListItem>
      </List>
      <Divider />
      <List style={{ backgroundColor: '#3C4B64' }}>
